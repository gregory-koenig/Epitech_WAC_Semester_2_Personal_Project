...
$b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, array(0 => ($this->targetDirs[3].'/src/Webacademie/IntranetBundle/Entity'))), 'Webacademie\\IntranetBundle\\Entity');
...
$a->setEntityNamespaces(array('WebacademieIntranetBundle' => 'Webacademie\\IntranetBundle\\Entity'));
